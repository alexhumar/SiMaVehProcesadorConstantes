...
namespace SiMaVeh.Domain.DataSeed.Fixtures.Localidad.FixtureGetters.Argentina
{
    class LocalidadBuenosAiresFixtureGetter : LocalidadFixtureGetter
    {
        ...
        protected override void Initialize()
        {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoBuenosAires.GeneralMadariaga).Id, new List<DatosEntidad>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoBuenosAires.LaMatanza).Id, new List<DatosEntidad>
            {
                ...
                datosEntidadBuilder.Build(426, LocalidadBuenosAires.20DeJunio),
            ...
            {
                datosEntidadBuilder.Build(893, LocalidadBuenosAires.25DeMayo),
