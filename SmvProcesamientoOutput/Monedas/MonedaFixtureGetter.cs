...
namespace SiMaVeh.Domain.DataSeed.Fixtures.Moneda.FixtureGetters
{
    ...
    internal class MonedaFixtureGetter : IMonedaFixtureGetter
    {
        ...
        private void Initialize()
        {
            ...
            monedas.Add(datosEntidadBuilder.Build(Constants.Monedas.CodigoISOMoneda.MXV, Constants.Monedas.Moneda.UnidadDeInversionUDIMexicana));
            ...
            monedas.Add(datosEntidadBuilder.Build(Constants.Monedas.CodigoISOMoneda.XBA, Constants.Monedas.Moneda.UnidadCompuestaEuropeaEURCOUnidadDelMercadosDeBonos));
            monedas.Add(datosEntidadBuilder.Build(Constants.Monedas.CodigoISOMoneda.XBB, Constants.Monedas.Moneda.UnidadMonetariaEuropeaEMU6UnidadDelMercadoDeBonos));
            monedas.Add(datosEntidadBuilder.Build(Constants.Monedas.CodigoISOMoneda.XBC, Constants.Monedas.Moneda.UnidadEuropeaDeCuenta9EUA9UnidadDelMercadoDeBonos));
            monedas.Add(datosEntidadBuilder.Build(Constants.Monedas.CodigoISOMoneda.XBD, Constants.Monedas.Moneda.UnidadEuropeaDeCuenta17EUA17UnidadDelMercadoDeBonos));
